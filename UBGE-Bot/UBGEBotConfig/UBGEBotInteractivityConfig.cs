...
namespace UBGE_Bot.UBGEBotConfig
{
    public class UBGEBotInteractivityConfig
    {
        ...
        {
            var jsonConfig = JsonConvert.DeserializeObject<UBGEBotInteractivityConfig>(File.ReadAllText(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "JsonUBGE_Bot", "InteractivityConfig.json")));
